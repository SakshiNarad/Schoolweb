        ...
        switch(content) {
            ...
            <div class="report-container"> 
                ...
                <div class="report-body"> 
                    ...
                    <div class="items"> 
                        <div class="item1"> 
                            <h3 class="t-op-nextlvl">Class1</h3> 
                            <h3 class="t-op-nextlvl">700</h3> 
                            <h3 class="t-op-nextlvl">700</h3> 
                            <h3 class="t-op-nextlvl label-tag">100%</h3> 
                        </div> 

                        <div class="item1"> 
                            <h3 class="t-op-nextlvl">Class 2</h3> 
                            <h3 class="t-op-nextlvl">650</h3> 
                            <h3 class="t-op-nextlvl">600</h3> 
                            <h3 class="t-op-nextlvl label-tag">98%</h3> 
                        </div> 

                        <div class="item1"> 
                            <h3 class="t-op-nextlvl">Class 3</h3> 
            ...
            case 'contact':
              ...
              ;
                break;
            case 'attendance':
                contentContainer.innerHTML = `<h2> Today's Attendance Record</h2>
                ...
                function generateRows() {
                    const students = [
                        {  class: 1, total: 30, present: 25, absent: 5 },
                        {  class: 2, total: 28, present: 22, absent: 6 },
                        {  class: 3, total: 35, present: 30, absent: 5 },
                        ...
                        {  class: 11, total: 87, present: 86, absent: 1 },
                        {  class: 12, total: 95, present: 93, absent: 2 },
            ...
            case 'query':
                contentContainer.innerHTML =  `<div id="container" class="query"></div>`
                    ...
                    const students = [
                        { name: 'John Doe', query: 'What is the syllabus for the upcoming exam?', answer: 'The syllabus includes chapters 1 to 5 from the textbook.' },
                        { name: 'Jane Smith', query: 'How can I improve my essay writing skills?', answer: 'To improve essay writing skills, practice regularly and get feedback from peers or teachers.' },
                        { name: 'Alex Johnson', query: 'When will the project submission deadline be announced?', answer: 'The project submission deadline will be announced next Monday.' },
                        { name: 'Emily Davis', query: 'Can we get additional resources for the programming assignment?', answer: 'Yes, additional resources will be provided on the course website.' },
                        { name: 'Michael Brown', query: 'Are there any extra credit opportunities this semester?', answer: 'Extra credit opportunities will be discussed in the next class.' }
                    ];
